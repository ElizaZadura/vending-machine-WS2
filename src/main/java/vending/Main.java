...
public class Main {
    ...
    Product product = new Lollipop(30.00, "Lollipop");
        ...
        Product product2 = new Lollipop(45.00, "More expensive Lollipop");
        System.out.println(product2.examine());
        Product product3 = new Crunchie( 50.00, "Crunchie");

        var vendingMachine = new VendingMachineImpl(10);
        vendingMachine.addProduct(product);
        vendingMachine.addProduct(product2);
        vendingMachine.addProduct(product3);
        vendingMachine.addCurrency(20.00);
        ...
        System.out.println(vendingMachine.useProduct(3));
        System.out.println(vendingMachine.getDescription());
    }
